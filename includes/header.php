...
$meta_desc  = $meta_desc  ?? 'Palatul Noblesse — monument istoric din 1881, locație premium pentru nunți, botezuri, evenimente corporate, petreceri private și shooting-uri în centrul Bucureștiului.';
$canonical  = $canonical  ?? '/';
...
<header class="site-header">
  <div class="container-x inner">
    ...
    <nav class="nav-main">
      <a href="/"<?= nav_cls('home', $nav_active) ?>>Acasă</a>
      <a href="/despre.php"<?= nav_cls('despre', $nav_active) ?>>Despre</a>
      <a href="/portofoliu.php"<?= nav_cls('portofoliu', $nav_active) ?>>Portofoliu</a>
      <div class="dropdown">
        <a href="/servicii.php"<?= nav_cls('servicii', $nav_active) ?>>Servicii <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="chev"><polyline points="6 9 12 15 18 9"/></svg></a>
      ...
      <a href="/saloane.php"<?= nav_cls('saloane', $nav_active) ?>>Saloane</a>
      <a href="/galerie.php"<?= nav_cls('galerie', $nav_active) ?>>Galerie</a>
      <a href="/contact.php"<?= nav_cls('contact', $nav_active) ?>>Contact</a>
    </nav>
